    ...
    switch (t.nodeType) {
      ...
      case t.ELEMENT_NODE:
        ...
        if ("input" === o || "textarea" === o || "select" === o) {
          f = t.value
          "radio" !== c.type && "checkbox" !== c.type && f
            ? (c.value = f)
            : t.checked && (c.checked = t.checked)
        }
        if ("option" === o) {
        ...
        return {
          ...
          childNodes: [],
          isSVG:
            ((I = t), "svg" === I.tagName || I instanceof SVGElement || void 0),
          needBlock: r
        }
      case t.TEXT_NODE:
    ...
    function n(e) {
      ...
      if (t && t.tagName && !(b.indexOf(t.tagName) < 0)) {
        ...
        if ("password" !== n && !t.classList.contains(C)) {
          var o = t.value,
            u = !1
          ;("radio" !== n && "checkbox" !== n) || (u = t.checked),
            r(t, { text: o, isChecked: u })
          var a = t.name
          "radio" === n &&
            a &&
            u &&
            document
              .querySelectorAll('input[type="radio"][name="' + a + '"]')
              .forEach(function (e) {
          ...
          e.forEach(function (e) {
            ...
            switch (t) {
              ...
              case "attributes":
                ...
                m || ((m = { node: u, attributes: {} }), r.push(m)),
                  (m.attributes[p] = f)
              case "childList":
                s.forEach(function (e) {
                  ...
                  l.forEach(function (e) {
                    i.has(e)
                      ? (i.delete(e), a.push(e))
                      : (i.has(u) && !h.getId(e)) ||
                        o.push({ parentId: h.getId(u), id: h.getId(e) }),
            ...
            (o = o.map(function (e) {
              return (
                e.parentNode &&
                  ((e.parentId = h.getId(e.parentNode)), delete e.parentNode),
                e
              )
            })),
            Array.from(i).forEach(function (e) {
              ...
              o.some(function (e) {
                ...
                : u.push({
                    ...
                    previousId: e.previousSibling
                      ? h.getId(e.previousSibling)
                      : e.previousSibling,
                    nextId: e.nextSibling
                      ? h.getId(e.nextSibling)
                      : e.nextSibling,
    ...
    try {
      ...
      var o = function () {
        n(
          D({
            type: p.Meta,
            data: { href: window.location.href, width: g(), height: y() }
          })
        )
        var e = s(document),
          o = e[0],
            ...
            T({
              ...
              mousemoveCb: function (e) {
                return n(
                  D({
                    type: p.IncrementalSnapshot,
                    data: { source: f.MouseMove, positions: e }
                  })
                )
              },
              mouseInteractionCb: function (e) {
                return n(
                  D({
                    type: p.IncrementalSnapshot,
                    data: t({ source: f.MouseInteraction }, e)
                  })
                )
              },
              scrollCb: function (e) {
              ...
              viewportResizeCb: function (e) {
                return n(
                  D({
                    type: p.IncrementalSnapshot,
                    data: t({ source: f.ViewportResize }, e)
                  })
                )
              },
              inputCb: function (e) {
